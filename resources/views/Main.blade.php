...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@100..900&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Sora:wght@100..800&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <section class="fading" style="display: none;">
        <div class="fixed mt-24 w-full h-full bg-black bg-opacity-50 flex justify-center items-center z-10">
    ...
    <x-userforgotpass-popup />

    @include('Header')

    <div class="mx-auto w-[1072px] custom-background" id="pages">
        @yield('body')
    </div>
