        ...
        <section class="h-[126px] bg-[#2CFBFE]">
            <section class="flex">
                ...
                <div class="w-[409px] mt-12 mx-6">
                    <div>
                        <b class="text-[30px] text-[#020B75]">{{ $name }}</b>
                        <p></p>
                    </div>
                    <div>
            ...
            <section class="grid" style="grid-template-columns: 1fr 2fr 1fr;">
                <div class="mt-8">
                    <div class="flex items-center">
                        <img src={{ asset('images/ext1.png') }} alt="" class="w-[17px] h-[17px]"> <span
                            class="mx-3">Lives in Ulan-Bator</span>
                    </div>
                    <div class="flex items-center my-1">
                        <img src={{ asset('images/ext2.png') }} alt="" class="w-[17px] h-[17px]"> <span class="mx-3">0
                            Articles Published</span>
                    </div>
                    <div class="flex items-center my-1">
                        <img src={{ asset('images/ext3.png') }} alt="" class="w-[17px] h-[17px]"> <span class="mx-3">0
                            Content Views</span>
                    </div>
                    <div class="flex items-center my-1">
                        <img src={{ asset('images/ext4.png') }} alt="" class="w-[17px] h-[17px]"> <span
                            class="mx-3">0 Events Posted</span>
                    </div>
                    <div class="flex items-center">
                        <img src={{ asset('images/ext5.png') }} alt="" class="w-[17px] h-[17px]"> <span
                            class="mx-3">Joined Feb 2020</span>
                    </div>
                </div>
                <div>
                    <b class="text-[30px] text-[#020B75]">Тухай</b>
                    <p></p>
                            ...
                            <div class="my-4 grid" style="grid-template-columns: 1fr 5fr;">
                                <div class="px-1">
                                    <img src={{ asset('images/startup.png') }} alt=""
                                        class="w-[71px] h-[71px] rounded-lg">
                                </div>
                                <div>
                                    <b>{{ $nm->head }}</b>
                                    <p></p>
                                    <div class="flex items-end">
                                        <img src={{ asset('storage/' . $img) }} alt=""
                                            class="w-[25px] h-[24.59px] rounded-full">
                                        <span class="px-2">{{ $name }} <span
                                                class="px-2">{{ $nm->created_at }}</span></span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div>
                    <b class="text-[20px] text-[#020b75]">Туршлага</b>
                    <p></p>
                    <div class="grid bg-[white]" style="grid-template-columns: 2fr 1fr;">
                        @foreach ($turshlaga->bridgeToSkill as $t)
                            <div class="px-2">
                                <b class="text-[13.66px] text-[#020B75]">{{ $t->Role }}</b>
                                <p></p>
                                <span class="text-[13.66px]">{{ $t->Company }}</span>
                                <p></p>
                                <span class="text-[12px]">{{ $t->start_month }} <span
                                        class="text-[12px] mx-1">{{ $t->start_year . ' - present' }}</span></span>
                            </div>
                            <div class="px-1">
