...
<body class="w-[1280px]" style="margin: 0 auto;">
        ...
        <nav class="w-[1280px] h-[96px] bg-[white]" style="display: grid; grid-template-rows: 0fr 0fr;">
            ...
            <div style="display: grid; grid-template-columns: 0.8fr 10fr 0.8fr;">
                ...
                <div class="bg-white-500 flex justify-between">
                    ...
                    <span class="m-[5px] cursor-pointer">НЭВТРЭХ</span>
    ...
    <section style="display: block;">
        <form method="post" action='/user/checkLogin' class="w-[710px] h-[474px] grid fixed" style="grid-template-columns: 1fr 1fr; margin: 100px 310px; ">
            @csrf
            @if ($errors)
            ...
            <section style="background-color: white;">
                ...
                <div class="mt-6 text-center">
                    <input type="text" placeholder="admin@company.com" name="email" class="w-[296px] h-[35px]" style="border-style: solid; border-color: black; border-width: 2px; border-right: none; border-left: none; border-top: none;">
                </div>
                <div class="mt-6 text-center">
                    <input type="password" placeholder="password" name="password" class="w-[296px] h-[35px]" style="border-style: solid; border-color: black; border-width: 2px; border-right: none; border-left: none; border-top: none;">
                </div>
                <div class="px-8">
                    <span class="text-[12px]">Та хараахан дансгүй байна уу? <a href="/user/signup" class="text-[#0029FF]">Бүргтгүүлэх</a></span>
                </div>
                <div class="mt-4 flex justify-between px-10">
                    <span class="my-2 text-[#0029FF] w-[141px]">Нууц үгээ мартсан</span>
                    <button class="w-[120px] h-[48px] bg-[#020B75] text-[#2CFBFE]" style="border-radius: 10px;">Нэвтрэх</button>
                </div>
                <div class="px-8 my-4">
